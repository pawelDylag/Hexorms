...
@RemoteView
public class HexagonalLayout extends ViewGroup {

    @SuppressWarnings("unused")
    private static final String TAG = HexagonalLayout.class.getSimpleName();
    ...
    public HexagonalLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public HexagonalLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        supportedChildern = wCount * hCount;
        if (startIndented) {
            supportedChildern--;
        }
    ...
    public ViewGroup.LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new HexagonalLayout.LayoutParams(getContext(), attrs);
    }

    // Override to allow type-checking of LayoutParams.
    @Override
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof HexagonalLayout.LayoutParams;
    }
